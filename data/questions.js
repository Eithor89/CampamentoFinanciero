...
const questions = [
    ...
    // SECCION 1: PROVISIONES DEL CAMPAMENTO (LIQUIDEZ)
    {
        ...
        mountainText: "Tus provisiones basicas en el campamento base. Lo que tienes a mano hoy mismo!",
    ...
    // SECCION 2: EQUIPAMIENTO DE ASCENSO (INVERSIONES)
    {
        ...
        mountainText: "Tus bastones de trekking. ¡Con cada paso que das, te impulsan mas arriba y mas rapido!",
    ...
    },
    {
        ...
        azorMessage: "Los planes de pensiones son tu BRÚJULA Y MAPA para la parte mas alta de la montaña. No los necesitas hoy, pero cuando llegues al tramo final de la ruta... seran tu guía mas valiosa. ¿Cuánto vale tu brújula?",
        icon: "🧭",
        type: "currency",
        section: "investments",
        sectionTitle: "Equipamiento de Ascenso",
    ...
    // SECCION 3: REFUGIOS Y VEHICULOS (BIENES)
    {
        ...
        mountainText: "Tus refugios de montaña. Solidos, seguros y que ganan valor con el tiempo.",
    ...
    },
    {
        ...
        mountainText: "Tu vehiculo todo-terreno. Útil para llegar a la montaña, aunque se oxida con el tiempo!",
        azorMessage: "El todo-terreno de la expedicion! El coche es útil pero tiene un defecto: pierde valor con cada kilómetro. ¿Cuánto vale aproximadamente?",
        icon: "🚗",
        type: "currency",
        section: "property",
        sectionTitle: "Refugios y Vehiculos",
    ...
    // SECCION 4: EL PESO DE LA MOCHILA (DEUDAS)
    {
        ...
        mountainText: "Las piedras mas grandes de tu mochila. Pesadas, pero las llevas para tener refugio propio!",
    ...
    {
        id: "bankLoan",
        text: "¿Cuánto debes en prestamos personales o bancarios?",
    ...
    },
    {
        ...
        mountainText: "El peso del todo-terreno que aun no has terminado de pagar.",
    ...
    // SECCION 5: RITMO DE ASCENSO (INGRESOS Y GASTOS)
    {
        ...
        mountainText: "Tu velocidad de ascenso. Lo que caminas cada mes.",
    ...
    },
    {
        ...
        mountainText: "El peso que cargamos cada mes. Cuanto menos peso innecesario, mas rapido subimos!",
